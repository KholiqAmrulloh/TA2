...
<head>
    ...
    <!-- datatables -->
    <link rel="stylesheet" href="vendor/sbadmin2/vendor/datatables/dataTables.bootstrap4.min.css">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link collapsed" href="/kmedoidsClustering">
                    ...
                    <span>K-Medoids Clustering</span>
                </a>
            </li>
            <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-center">Medoid</h3>
                    <div class="card">
                        <div class="card-body">
                            <table style="font-size: 12px" id="example" class="table table-striped table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $rd->total_stock_barang_awal; }}</td>
                                        <td>{{ $rd->transaksi; }}</td>
                                        <td>{{ $rd->barang_terjual; }}</td>
                                        <td>{{ $rd->sisa_barang; }}</td>
                                        <td>{{ $rd->keuntungan; }}</td>
                                        <td>{{ $rd->ratarata_penjualan_pertahun; }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    <h3 class="text-center" style="margin-top: 8px">Dataset</h3>
                    <div class="card">
                        <div class="card-body">
                            <table style="font-size: 12px" id="example1" class="table table-striped table-bordered" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama Barang</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item['total_stock_barang_awal'] }}</td>
                                        <td>{{ $item['transaksi'] }}</td>
                                        <td>{{ $item['barang_terjual'] }}</td>
                                        <td>{{ $item['sisa_barang'] }}</td>
                                        <td>{{ $item['keuntungan'] }}</td>
                                        <td>{{ $item['ratarata_penjualan_pertahun'] }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    <div style="margin-top: 5px">
                        <button type="button" class="btn btn-success" style="float: right" data-toggle="modal" data-target="#deleteModal">
                            Proses
                        </button>
                    </div>
                </div>

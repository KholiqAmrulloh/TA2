            ...
            <div id="content">
                ...
                <div class="container-fluid" style="margin-top: 10%">
                    <div class="card">
                        <div class="card-body">
                            <center>
                            <a style="font-family: 'Roboto'; font-size: 30px; color:black">
                                <b>Selamat Datang {{auth()->user()->name}}<br>Di Sistem Perbandingan Metode Evaluasi<br>Davies-Bouldin Index dan Silhouette Coefficient<br>Dengan Algoritma K-Medoids</b>
                            </a>
                            </center><br><br>
                            <p style="font-size: 18px" align="justify">
                                Algoritma K-Medoids atau Partitioning Around Medoids (PAM) merupakan suatu metode partisi clustering untuk mengelompokkan sekumpulan (n) objek menjadi sejumlah (k) cluster. Algoritma K-Medoids menggunakan objek pada kumpulan objek untuk mewakili sebuah cluster. 
                            </p>
                        </div>
                    </div>

                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        <div style="padding-bottom: 5px">
                            ...
                            <button type="button" class="btn btn-danger btn-sm" style="float: right" data-toggle="modal" data-target="#deleteModal">
                    ...
                    {{-- modal import data --}}
                    <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form action="/hasilImport" method="post" enctype="multipart/form-data">
                                    @csrf

            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            <div class="card o-hidden border-0 my-5 col-lg-7 mx-auto" style="background-color: azure">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg">
                                            @if(session()->has('nilaik'))
                                            ...
                                            @endif
                                            <div class="p-5">
                                                <h3 style="color: black">Tentukan Nilai K<br></h3>
                                                <form action="/nilaiK" method="post">
                                                    @csrf
                                                    <div class="form-group">
                                                        <input type="text" name="nilaik" id="nilaik" required><br>
                                                    </div>
                                                    <div>
                                                        <span>
                                                            <button type="submit" class="btn btn-primary btn-sm">
                                                                <i class="fas fa-spinner"></i> Apply
                                                            </button>
                                                        </span>
                                                        <span>
                                                            <a type="button" href="/nilaiK/reset" class="btn btn-danger btn-sm">
                                                                Reset
                                                            </a>
                                                        </span>
                                                    </div>
